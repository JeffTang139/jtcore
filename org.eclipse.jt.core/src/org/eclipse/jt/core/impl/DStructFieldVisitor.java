 ...
 * 
 */
final class DStructFieldVisitor implements VariableValue {
	...
	private DynObj target;

	final void reset(StructFieldDefineImpl targetField, DynObj target) {
		if (target == null) {
	...
	DStructFieldVisitor(StructFieldDefineImpl targetField, DynObj target) {
