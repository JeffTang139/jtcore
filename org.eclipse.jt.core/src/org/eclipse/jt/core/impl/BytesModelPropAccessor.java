...
final class BytesModelPropAccessor extends ModelPropAccessor {
	...
	byte[] getPropValueAsBytes(ContextImpl<?, ?, ?> context,
		...
		if (propAccessDefine.script != null
			...
			return Convert.toBytes(propAccessDefine.script.executeScriptAsGetter(
			...
			try {
				return propAccessDefine.accessor.doGetBytes(context, mo,
			...
			return propAccessDefine.field.getFieldValueAsBytes(mo);
		} else {
	...
	void setPropValueAsBytes(ContextImpl<?, ?, ?> context,
		...
		if ((propAccessDefine.script == null || !propAccessDefine.script
				...
				SpaceNode occorAtSave = propAccessDefine.accessor.getService()
						.updateContextSpace(context);
				try {
					propAccessDefine.accessor.doSetBytes(context, mo,
				...
				propAccessDefine.field.setFieldValueAsBytes(mo, value);
			} else {
				throw new UnsupportedOperationException();
			}
...
@Override
	void setPropValueAsBoolean(ContextImpl<?, ?, ?> context,
			ModelPropAccessDefineImpl propAccessDefine, Object mo, 
			boolean value) {
		this.setPropValueAsBytes(context, propAccessDefine, mo, 
				Convert.toBytes(value));
	}
	@Override
	boolean getPropValueAsBoolean(ContextImpl<?, ?, ?> context,
			ModelPropAccessDefineImpl propAccessDefine, Object mo) {
		return Convert.toBoolean(this.getPropValueAsBytes(context, propAccessDefine, mo));
	}
	@Override
	...
	byte getPropValueAsByte(ContextImpl<?, ?, ?> context,
			ModelPropAccessDefineImpl propAccessDefine, Object mo) {
		return Convert.toByte(this.getPropValueAsBytes(context, propAccessDefine, mo));
	}
	@Override
	...
	short getPropValueAsShort(ContextImpl<?, ?, ?> context,
			ModelPropAccessDefineImpl propAccessDefine, Object mo) {
		return Convert.toShort(this.getPropValueAsBytes(context, propAccessDefine, mo));
	}
	@Override
	...
	int getPropValueAsInt(ContextImpl<?, ?, ?> context,
			ModelPropAccessDefineImpl propAccessDefine, Object mo) {
		return Convert.toInt(this.getPropValueAsBytes(context, propAccessDefine, mo));
	}
	@Override
	...
	long getPropValueAsLong(ContextImpl<?, ?, ?> context,
			ModelPropAccessDefineImpl propAccessDefine, Object mo) {
		return Convert.toLong(this.getPropValueAsBytes(context, propAccessDefine, mo));
	}
	@Override
	...
	long getPropValueAsDate(ContextImpl<?, ?, ?> context,
			ModelPropAccessDefineImpl propAccessDefine, Object mo) {
		return Convert.toDate(this.getPropValueAsBytes(context, propAccessDefine, mo));
	}
	@Override
	...
	double getPropValueAsDouble(ContextImpl<?, ?, ?> context,
			ModelPropAccessDefineImpl propAccessDefine, Object mo) {
		return Convert.toDouble(this.getPropValueAsBytes(context, propAccessDefine, mo));
	}
	@Override
	...
	float getPropValueAsFloat(ContextImpl<?, ?, ?> context,
			ModelPropAccessDefineImpl propAccessDefine, Object mo) {
		return Convert.toFloat(this.getPropValueAsBytes(context, propAccessDefine, mo));
	}
	@Override
	...
	String getPropValueAsString(ContextImpl<?, ?, ?> context,
			ModelPropAccessDefineImpl propAccessDefine, Object mo) {
		return Convert.toString(this.getPropValueAsBytes(context, propAccessDefine, mo));
	}
	@Override
	...
	GUID getPropValueAsGUID(ContextImpl<?, ?, ?> context,
			ModelPropAccessDefineImpl propAccessDefine, Object mo) {
		return Convert.toGUID(this.getPropValueAsBytes(context, propAccessDefine, mo));
	}
	@Override
	...
	Object getPropValueAsObject(ContextImpl<?, ?, ?> context,
			ModelPropAccessDefineImpl propAccessDefine, Object mo) {
		return Convert.toObject(this.getPropValueAsBytes(context, propAccessDefine, mo));
	}
		private BytesModelPropAccessor() {
	}
	static final BytesModelPropAccessor ACCESSOR = new BytesModelPropAccessor();
}
